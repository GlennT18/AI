...
class StraightLineHeuristic(Heuristic):
    ...
    def __init__(self, end_tag: str, city_map: CityMap):
        self.end_tag = end_tag
        self.city_map = city_map
        self.end_location = self.city_map.geolocations[self.end_tag]
    ...
    def evaluate(self, state: State) -> float:
       # TODO: 6 lines
        ...
        end_location = self.city_map.geolocations[state.location]
        end = Geolocation(end_location.latitude, end_location.longitude)
